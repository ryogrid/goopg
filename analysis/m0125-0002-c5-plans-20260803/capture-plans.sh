#!/usr/bin/env bash
# M0125-0002 commit 5 — TPC-DS SF0.5 plan-vs-plan capture, one arm per binary.
#
...
OUT="analysis/m0125-0002-c5-plans-20260803/${ARM}"
