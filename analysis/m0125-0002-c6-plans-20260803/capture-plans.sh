#!/usr/bin/env bash
# M0125-0002 commit 6 — TPC-DS SF0.5 plan-vs-plan capture, one arm per binary.
#
...
OUT="analysis/m0125-0002-c6-plans-20260803/${ARM}"
