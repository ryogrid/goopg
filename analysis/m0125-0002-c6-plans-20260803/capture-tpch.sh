#!/usr/bin/env bash
# M0125-0002 commit 6 — TPC-H plan-snapshot capture, one arm per binary.
#
# Same instrument the c3/c4 arms used, scripted this time because commit 6 is
...
PG_PORT=65433
PG_HOST=127.0.0.1
CG_UNIT="goopg-tpch-c6"
LOG="${REPO_ROOT}/analysis/m0125-0002-c6-plans-20260803/${LABEL}.server.log"
