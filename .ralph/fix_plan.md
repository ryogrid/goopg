...
## Current Priority (per 2026-08-14 — M0119)
...
all S1–S13 landed 2026-08-13. M0133 (`information_schema` on disk) is COMPLETE —
all S1–S4 landed 2026-08-14 (namespace 13273 + 5 domains + 11 helpers + 4 data
tables/801 rows + 65 views, all evaluated by a hosted PG 18.3).** M0131 is now
closed except S24 (durable MultiXact SLRU — explicitly DEFERRED with an
executable re-arm trigger; not selectable). M0130 is closed. The next-priority
milestone is therefore **M0119 (deferral-ledger backlog consumption)**, then
M0122 — the two remaining M0119 items (M0119-0005 pg_waldump server tier,
M0119-0006 pg_amcheck server tier) are selected top-to-bottom from this file.
Work M0119 immediately after M-NIGHTLY's regression fixes. Document order does
NOT reflect priority here; this banner does.
