...
- [~] EX1-02b Index/bitmap/IOS bound threading — design `docs/design/executor-ex1-02b-index/DESIGN.md` (reviewed, no blockers); implementation still to run before close.
