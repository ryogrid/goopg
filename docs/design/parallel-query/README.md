...
| [13](13-cooperative-parallel-hash-build.md) | Cooperative Parallel Hash Build (M0129-S4.1) | Producer/consumer split for the hash join build side: N goroutines parallelise the scan+filter while one goroutine owns the hash map. Reopen condition MET by M0128-P2.1 (build time 12.6–41.0 %). |
