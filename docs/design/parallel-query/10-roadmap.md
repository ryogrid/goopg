...
| Cooperative parallel hash **build** | The build side is the small side by planner construction (`IsSmallDimensionSide`, `internal/planner/cardinality.go:167`); this is the one place PG's design is genuinely more advanced ([07](07-parallel-hash-join.md) §3.1) | A measured plan where build time dominates — **the measurement itself is filed as M0128-P2.1** (2026-08-07; see [../0128-special-join-inference-and-m0127-residuals.md](../0128-special-join-inference-and-m0127-residuals.md) §3) |
