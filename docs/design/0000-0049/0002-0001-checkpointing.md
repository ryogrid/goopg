...
| Refines     | [root-0008-wal-and-recovery.md](../../root/root-0008-wal-and-recovery.md) |
| Supersedes  | —                              |
...
- Buffer pool internals:
  [root-0005-buffer-manager.md](../../root/root-0005-buffer-manager.md).
- WAL writer & recovery seam:
  [root-0008-wal-and-recovery.md](../../root/root-0008-wal-and-recovery.md).
- GUC system:
  [root-0004-configuration-and-guc.md](../../root/root-0004-configuration-and-guc.md).
