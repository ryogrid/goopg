...
| 0003-0004 | [HammerDB TPC-H Integration (M0003)](0003-0004-hammerdb-tpch-integration.md) | draft | TPC-H DDL runs end-to-end. Adds NUMERIC/DECIMAL codec (varlen text round-trip; integer→string formatting for INSERTs) and decimal / scientific literal lexer (TokenNumericLit + parser.NumericConst). All eight HammerDB tables CREATE; round-trip INSERTs with `901.01` and `1.5e3` literals verified via psql 18.3. |
