...
| 0092 | Lazy row emission in indexScanOp + projectOp (structural cloneRow elimination; Materialize-always-deep-copies contract; NLI currentOuter deep-copy) | structural changes landed; pgbench-c10 TPS did NOT improve (510 → 437); broadly-distributed residual allocations need a follow-up milestone | `0092-lazy-row-emission-in-scan-and-project.md` |
