...
func TestExtendedQueryExecutorBindParameter(t *testing.T) {
	...
	writeFrontendFrame(t, conn, libpq.MsgParse, parsePayload("ins", "INSERT INTO items VALUES ($1, $2)", nil))
	writeFrontendFrame(t, conn, libpq.MsgBind, bindPayload("", "ins", nil, []bindParam{{value: "42"}, {value: "answer"}}, nil))
