...
func (s *Server) execTwoPhaseStmt(w *libpq.FrameWriter, ctx *executor.Context, stmt parser.Stmt, connTx *connTxState, autoCommitPtr *bool) (bool, error) {
	switch st := stmt.(type) {
...
func (s *Server) execPrepareTransaction(w *libpq.FrameWriter, ctx *executor.Context, st *parser.PrepareTransactionStmt, connTx *connTxState, autoCommitPtr *bool) error {
	if connTx == nil || !connTx.InExplicit() {
		return s.writeQueryError(w, errcodes.NoActiveSQLTransaction,
...
func (s *Server) abortForPrepareSSIFailure(w *libpq.FrameWriter, ctx *executor.Context, connTx *connTxState, explicitTx transam.Transaction, ssiErr error) error {
...
func (s *Server) execFinalizePrepared(w *libpq.FrameWriter, ctx *executor.Context, gid string, connTx *connTxState, autoCommitPtr *bool, finalize parser.Stmt) error {
