...
// then applies.
func (s *Server) effectiveLogStatementLevel(sess *misc.SessionRegistry) logStatementLevel {
	lvl := s.logStmtLevel
	if sess == nil {
		return lvl
	}
...
func (s *Server) logStatement(proto string, sql string, sess *misc.SessionRegistry, connTx *connTxState) bool {
...
func sessionLogMinDurationStatement(sess *misc.SessionRegistry) int64 {
	if sess == nil {
		return -1
	}
...
// exceeded.
func (s *Server) logDuration(start time.Time, wasLogged bool, proto string, sql string, sess *misc.SessionRegistry, connTx *connTxState) {
...
func (s *Server) logLinePrefix(sess *misc.SessionRegistry, connTx *connTxState) string {
...
func (s *Server) prefixAttr(sess *misc.SessionRegistry, connTx *connTxState) []any {
