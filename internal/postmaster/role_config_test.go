...
func TestTryHandleRoleDDLAlterRoleConfig(t *testing.T) {
	...
	if got := roleErrorSQLState(err); got != errcodes.UndefinedObject {
		t.Errorf("ALTER ROLE nosuchrole SET: SQLSTATE = %q, want %q", got, errcodes.UndefinedObject)
	}
}
...
func TestTryHandleRoleDDLAlterRoleConfigFromCurrent(t *testing.T) {
	...
	if got := roleErrorSQLState(err); got != errcodes.UndefinedObject {
		t.Errorf("SQLSTATE = %q, want %q", got, errcodes.UndefinedObject)
	}
...
func TestTryHandleRoleDDLAlterRoleAll(t *testing.T) {
	...
	if got := roleErrorSQLState(err); got != errcodes.UndefinedObject {
		t.Errorf(`ALTER ROLE "ALL" SET: SQLSTATE = %q, want %q`, got, errcodes.UndefinedObject)
	}
}
