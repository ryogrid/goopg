...
func TestNLIArmOffersBothCandidates(t *testing.T) {
	...
	addNLIPaths(s, joinrel, outer, inner, cp, parser.JoinInner, nil, 0, uniqueSideNone, nil)
	...
	addNLIPaths(sBlind, blindRel, outer, blindInner, cp, parser.JoinInner, nil, 0, uniqueSideNone, nil)
