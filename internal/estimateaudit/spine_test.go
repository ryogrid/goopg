  ...
  ->  HashAggregate (3 keys)  (cost=0.00..0.00 rows=12163 width=0) (actual time=1.0..1.1 rows=4.00 loops=1)
    ->  Hash Join (INNER)  (cost=0.00..0.00 rows=12163 width=0) (actual time=1.0..1.1 rows=5869.00 loops=1)
      ->  Hash Join (INNER)  (cost=0.00..0.00 rows=304087 width=0) (actual time=1.0..1.1 rows=147791.00 loops=1)
        ...
        ->  Hash Join (INNER)  (cost=0.00..0.00 rows=1200 width=0) (actual time=1.0..1.1 rows=813.00 loops=1)
          ->  Seq Scan on public.supplier (stats)  (cost=0.00..0.00 rows=10000 width=0) (actual time=1.0..1.1 rows=10000.00 loops=1)
          ->  Nested Loop (INNER)  (cost=0.00..0.00 rows=3 width=0) (actual time=1.0..1.1 rows=2.00 loops=1)
