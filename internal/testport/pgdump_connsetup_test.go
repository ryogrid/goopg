...
func TestPort_PgDumpConnectionSetup(t *testing.T) {
	...
	if res.ExitCode == 0 {
		...
		// **Slice 225 + 226 + 227 + 228 + 229 + 230 + 231 + 232 + 233 closed (asserted):**
