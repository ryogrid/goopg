...
func TestPort_PgDumpConnectionSetup(t *testing.T) {
	...
	// `toast.autovacuum_multixact_freeze_max_age='500000000'`.
	...
	if res.ExitCode == 0 {
		...
		// (toast.autovacuum_vacuum_cost_limit), and five RELOPT_KIND_TOAST
