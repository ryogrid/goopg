...
func colSQLTypmod(colSQL string) int32 {
	...
	return nodes.ColumnTypmod(typeName, args)
}
...
func numericColSQLTypmod(colSQL string) int32 {
	...
	return nodes.NumericColumnTypmod(args)
}
...
var adbinOracleCases = []adbinOracleCase{
	...
	{"int4_const", "int", nodes.OidInt4, "5"},
	{"int4_neg", "int", nodes.OidInt4, "-1"},
	{"int8_const", "int8", nodes.OidInt8, "5000000000"},
	{"text_literal", "text", nodes.OidText, "'hi'"},
	{"numeric_decimal", "numeric", nodes.OidNumeric, "100.50"},
	{"numeric_sci", "numeric", nodes.OidNumeric, "1E-10"},
	{"numeric_neg", "numeric", nodes.OidNumeric, "-2.5"},
	// int4→numeric implicit cast FuncExpr (funcid 1740) stored, NOT const-folded.
	{"numeric_int_cast", "numeric", nodes.OidNumeric, "12345"},
	// FuncExpr (built-in, not folded).
	{"func_upper", "text", nodes.OidText, "upper('x')"},
	// timestamptz literal → Const (timestamptz_in at store time).
	{"timestamptz_lit", "timestamptz", nodes.OidTimestamptz, "'2024-01-15 10:30:00+00'"},
	// BoolExpr / NullTest / OpExpr scalar nodes.
	{"bool_true", "bool", nodes.OidBool, "true"},
	{"is_null", "bool", nodes.OidBool, "1 IS NULL"},
	{"is_not_null", "bool", nodes.OidBool, "1 IS NOT NULL"},
	{"bool_and", "bool", nodes.OidBool, "true AND false"},
	{"bool_not", "bool", nodes.OidBool, "NOT true"},
	{"bool_and_flatten", "bool", nodes.OidBool, "(1 < 2) AND (3 > 2) AND (5 = 5)"},
	// BooleanTest (IS TRUE / IS UNKNOWN).
	{"is_true", "bool", nodes.OidBool, "true IS TRUE"},
	{"is_unknown", "bool", nodes.OidBool, "(1=1) IS UNKNOWN"},
	// DistinctExpr (IS [NOT] DISTINCT FROM) over int and text operands.
	{"distinct_int", "bool", nodes.OidBool, "1 IS DISTINCT FROM 2"},
	{"distinct_text", "bool", nodes.OidBool, "'x' IS DISTINCT FROM 'y'"},
	// CaseExpr: searched + simple form, same-type and cross-type (int→numeric,
	// int4→int8) coercion of the result arms.
	{"case_searched_int", "int", nodes.OidInt4, "CASE WHEN true THEN 1 ELSE 2 END"},
	{"case_simple_int", "int", nodes.OidInt4, "CASE 1 WHEN 1 THEN 10 ELSE 20 END"},
	{"case_bool", "bool", nodes.OidBool, "CASE WHEN (1<2) THEN true ELSE false END"},
	{"case_numeric_cast", "numeric", nodes.OidNumeric, "CASE WHEN true THEN 1 ELSE 2.5 END"},
	{"case_int8_widen", "int8", nodes.OidInt8, "CASE WHEN true THEN 1 ELSE 5000000000 END"},
	...
	{"case_simple_numeric_coerce", "numeric", nodes.OidNumeric, "CASE 5.0 WHEN 1 THEN 100.0 ELSE 200.0 END"},
	{"case_simple_numeric_coerce_multi", "numeric", nodes.OidNumeric, "CASE 3.5 WHEN 1 THEN 1.5 WHEN 2 THEN 2.5 ELSE 3.5 END"},
	...
	{"case_simple_int8_operand_int4_when", "int8", nodes.OidInt8, "CASE 5000000000 WHEN 1 THEN 10000000000 ELSE 20000000000 END"},
	{"case_simple_int4_operand_int8_when", "int", nodes.OidInt4, "CASE 1 WHEN 5000000000 THEN 10 ELSE 20 END"},
	...
	{"cast_int4_to_int2", "int2", nodes.OidInt2, "5::int2"},
	{"cast_int4_to_int8", "int8", nodes.OidInt8, "5::int8"},
	{"cast_int8_to_int4", "int", nodes.OidInt4, "9999999999::int4"},
	{"cast_int8_to_int2", "int2", nodes.OidInt2, "9999999999::int2"},
	{"cast_noop_int4", "int", nodes.OidInt4, "5::int4"},
	{"cast_noop_int8", "int8", nodes.OidInt8, "9999999999::int8"},
	{"case_simple_explicit_cast_operand", "int8", nodes.OidInt8, "CASE 5::int8 WHEN 1 THEN 10::int8 ELSE 20::int8 END"},
	...
	{"cast_numeric_to_int4", "int", nodes.OidInt4, "5.5::int4"},
	{"cast_numeric_to_int8", "int8", nodes.OidInt8, "5.5::int8"},
	{"cast_numeric_to_int2", "int2", nodes.OidInt2, "5.5::int2"},
	{"cast_neg_numeric_to_int4", "int", nodes.OidInt4, "(-2.5)::int4"},
	{"cast_int4_to_numeric", "numeric", nodes.OidNumeric, "5::numeric"},
	{"cast_int8_to_numeric", "numeric", nodes.OidNumeric, "9999999999::numeric"},
	...
	{"cast_int4_to_float4", "float4", nodes.OidFloat4, "5::float4"},
	{"cast_int4_to_float8", "float8", nodes.OidFloat8, "5::float8"},
	{"cast_int8_to_float4", "float4", nodes.OidFloat4, "9999999999::float4"},
	{"cast_int8_to_float8", "float8", nodes.OidFloat8, "9999999999::float8"},
	{"cast_numeric_to_float4", "float4", nodes.OidFloat4, "5.5::float4"},
	{"cast_numeric_to_float8", "float8", nodes.OidFloat8, "5.5::float8"},
	{"cast_nested_float8_to_int4", "int", nodes.OidInt4, "(5.5::float8)::int4"},
	...
	{"cast_int_to_numeric_10_2", "numeric(10,2)", nodes.OidNumeric, "5::numeric(10,2)"},
	{"cast_numeric_to_numeric_10_2", "numeric(10,2)", nodes.OidNumeric, "5.5::numeric(10,2)"},
	{"cast_int_to_numeric_10_0", "numeric(10,0)", nodes.OidNumeric, "5::numeric(10,0)"},
	...
	{"lencoerce_decimal_10_2", "numeric(10,2)", nodes.OidNumeric, "5.5"},
	{"lencoerce_int4_10_2", "numeric(10,2)", nodes.OidNumeric, "0"},
	{"lencoerce_int8_10_2", "numeric(10,2)", nodes.OidNumeric, "5000000000"},
	{"lencoerce_explicit_8_1_into_10_2", "numeric(10,2)", nodes.OidNumeric, "5.5::numeric(8,1)"},
	{"lencoerce_decimal_10_0", "numeric(10,0)", nodes.OidNumeric, "5.5"},
	...
	{"relabel_bare_explicit_8_1", "numeric", nodes.OidNumeric, "5.5::numeric(8,1)"},
	{"relabel_bare_int4_explicit_8_1", "numeric", nodes.OidNumeric, "5::numeric(8,1)"},
	...
	{"explicit_relabel_bare_8_1", "numeric", nodes.OidNumeric, "(5.5::numeric(8,1))::numeric"},
	{"explicit_relabel_bare_int4_8_1", "numeric", nodes.OidNumeric, "(5::numeric(8,1))::numeric"},
	...
	{"date_post_2000", "date", nodes.OidDate, "'2024-03-15'"},
	{"date_epoch", "date", nodes.OidDate, "'2000-01-01'"},
	{"date_pre_epoch", "date", nodes.OidDate, "'1999-12-31'"},
	...
	{"date_cast", "date", nodes.OidDate, "'2024-03-15'::date"},
	{"timestamptz_cast", "timestamptz", nodes.OidTimestamptz, "'2024-01-15 10:30:00+00'::timestamptz"},
	...
	{"str_cast_int4", "int", nodes.OidInt4, "'123'::int4"},
	{"str_cast_int4_neg", "int", nodes.OidInt4, "'-5'::int4"},
	{"str_cast_int8", "int8", nodes.OidInt8, "'123'::int8"},
	{"str_cast_int2", "int2", nodes.OidInt2, "'12'::int2"},
	{"str_cast_bool_true", "bool", nodes.OidBool, "'t'::bool"},
	{"str_cast_bool_false", "bool", nodes.OidBool, "'false'::bool"},
	{"str_col_int4", "int", nodes.OidInt4, "'123'"},
	{"str_col_bool_yes", "bool", nodes.OidBool, "'yes'"},
	...
	{"str_cast_text", "text", nodes.OidText, "'foo'::text"},
	{"str_cast_numeric", "numeric", nodes.OidNumeric, "'5.5'::numeric"},
	{"str_cast_numeric_scale", "numeric", nodes.OidNumeric, "'5.50'::numeric"},
	{"str_cast_numeric_neg", "numeric", nodes.OidNumeric, "'-2.5'::numeric"},
	{"str_col_numeric", "numeric", nodes.OidNumeric, "'5.5'"},
	...
	{"str_cast_numeric_nan", "numeric", nodes.OidNumeric, "'NaN'::numeric"},
	{"str_cast_numeric_inf", "numeric", nodes.OidNumeric, "'Infinity'::numeric"},
	{"str_cast_numeric_neg_inf", "numeric", nodes.OidNumeric, "'-Infinity'::numeric"},
	...
	{"str_cast_oid", "oid", nodes.OidOid, "'5'::oid"},
	{"str_col_oid", "oid", nodes.OidOid, "'42'"},
	{"str_cast_float8", "float8", nodes.OidFloat8, "'5'::float8"},
	{"str_cast_float8_decimal", "float8", nodes.OidFloat8, "'5.5'::float8"},
	{"str_cast_float8_neg", "float8", nodes.OidFloat8, "'-2.5'::float8"},
	{"str_cast_float8_sci", "float8", nodes.OidFloat8, "'1.5e10'::float8"},
	{"str_col_float8", "float8", nodes.OidFloat8, "'5.5'"},
	{"str_cast_float4", "float4", nodes.OidFloat4, "'5'::float4"},
	{"str_cast_float4_decimal", "float4", nodes.OidFloat4, "'5.5'::float4"},
	{"str_cast_float4_neg", "float4", nodes.OidFloat4, "'-2.5'::float4"},
	...
	{"varchar10_hello", "varchar(10)", nodes.OidVarchar, "'hello'"},
	{"varchar20_world", "varchar(20)", nodes.OidVarchar, "'world'"},
	{"varchar5_empty", "varchar(5)", nodes.OidVarchar, "''"},
	{"bpchar5_abc", "char(5)", nodes.OidBpchar, "'abc'"},
	{"bpchar10_xyz", "character(10)", nodes.OidBpchar, "'xyz'"},
	{"bpchar3_empty", "bpchar(3)", nodes.OidBpchar, "''"},
	...
	{"ts0_2024_01_15", "timestamp(0)", nodes.OidTimestamp, "'2024-01-15 10:30:00'"},
	{"ts3_2024_01_15_123456", "timestamp(3)", nodes.OidTimestamp, "'2024-01-15 10:30:00.123456'"},
	{"ts6_2024_01_15_123456", "timestamp(6)", nodes.OidTimestamp, "'2024-01-15 10:30:00.123456'"},
	{"ts0_truncate", "timestamp(0)", nodes.OidTimestamp, "'2024-01-15 10:30:00.123456'"},
	{"ts0_epoch", "timestamp(0)", nodes.OidTimestamp, "'epoch'"},
	...
	{"bit4_1010", "bit(4)", nodes.OidBit, "'1010'"},
	{"bit8_11110000", "bit(8)", nodes.OidBit, "'11110000'"},
	{"bit1_single", "bit(1)", nodes.OidBit, "'1'"},
	// Sub-slice 36: varbit(N) length coercion (funcid 1687, funcformat 2).
	{"varbit6_111000", "bit varying(6)", nodes.OidVarBit, "'111000'"},
	{"varbit8_10101010", "varbit(8)", nodes.OidVarBit, "'10101010'"},
	// varbit WITHOUT a length qualifier stores a bare Const.
	{"varbit_bare_10101", "bit varying", nodes.OidVarBit, "'10101'"},
	...
	{"tstz3_2024_frac", "timestamptz(3)", nodes.OidTimestamptz, "'2024-01-15 10:30:00.123456+00'"},
	{"tstz6_full", "timestamptz(6)", nodes.OidTimestamptz, "'2024-01-15 10:30:00.123456+00'"},
	{"tstz0_truncate", "timestamptz(0)", nodes.OidTimestamptz, "'2024-01-15 10:30:00.123456+00'"},
	{"tstz0_epoch", "timestamptz(0)", nodes.OidTimestamptz, "'epoch'"},
	// timestamptz WITHOUT a precision qualifier stores a bare Const.
	{"tstz_bare", "timestamptz", nodes.OidTimestamptz, "'2024-01-15 10:30:00+00'"},
	...
	{"t0_midnight", "time(0)", nodes.OidTime, "'00:00:00'"},
	{"t3_frac", "time(3)", nodes.OidTime, "'10:30:00.123456'"},
	{"t6_full", "time(6)", nodes.OidTime, "'10:30:00.123456'"},
	{"t0_trunc", "time(0)", nodes.OidTime, "'10:30:00.123456'"},
	// time WITHOUT a precision qualifier stores a bare Const.
	{"t_bare", "time", nodes.OidTime, "'10:30:00'"},
	...
	// the column has a precision qualifier (0-6).
	{"tz0_midnight_utc", "timetz(0)", nodes.OidTimeTZ, "'00:00:00+00:00'"},
	{"tz0_pos_offset", "timetz(0)", nodes.OidTimeTZ, "'10:30:00+05:30'"},
	{"tz3_frac", "timetz(3)", nodes.OidTimeTZ, "'10:30:00.123+05:30'"},
	{"tz6_full", "timetz(6)", nodes.OidTimeTZ, "'10:30:00.123456+05:30'"},
	{"tz0_trunc", "timetz(0)", nodes.OidTimeTZ, "'10:30:00.123456+05:30'"},
	{"tz0_zulu", "timetz(0)", nodes.OidTimeTZ, "'10:30:00Z'"},
	{"tz3_neg_offset", "timetz(3)", nodes.OidTimeTZ, "'10:30:00.100-03:00'"},
	// timetz WITHOUT a precision qualifier stores a bare Const.
	{"tz_bare", "timetz", nodes.OidTimeTZ, "'10:30:00+05:30'"},

	// Sub-slice 40: broader date input forms — infinity, BC years.
	{"date_infinity", "date", nodes.OidDate, "'infinity'"},
	{"date_neg_infinity", "date", nodes.OidDate, "'-infinity'"},
	{"date_0001_01_01_bc", "date", nodes.OidDate, "'0001-01-01 BC'"},
	{"date_0044_03_15_bc", "date", nodes.OidDate, "'0044-03-15 BC'"},
	{"ts_infinity", "timestamp", nodes.OidTimestamp, "'infinity'"},
	{"ts_neg_infinity", "timestamp", nodes.OidTimestamp, "'-infinity'"},
	{"ts_0001_01_01_bc", "timestamp", nodes.OidTimestamp, "'0001-01-01 00:00:00 BC'"},
	{"ts_0044_03_15_bc", "timestamp", nodes.OidTimestamp, "'0044-03-15 00:00:00 BC'"},
	{"tstz_infinity", "timestamptz", nodes.OidTimestamptz, "'infinity'"},
	{"tstz_neg_infinity", "timestamptz", nodes.OidTimestamptz, "'-infinity'"},
	{"tstz_0001_01_01_bc", "timestamptz", nodes.OidTimestamptz, "'0001-01-01 00:00:00+00 BC'"},
	{"tstz_0044_03_15_bc", "timestamptz", nodes.OidTimestamptz, "'0044-03-15 00:00:00+00 BC'"},
}
...
func TestOraclePgnodesAdbinBytesMatchPG(t *testing.T) {
	...
	for _, tc := range adbinOracleCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			node, ok := nodes.ResolveForColumnTypmod(expr, tc.colOid, colSQLTypmod(tc.colSQL))
			if !ok {
