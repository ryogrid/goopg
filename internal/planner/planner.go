...
func resolveExprAfterAggregate(e parser.Expr, agg *aggregateSurface) (Expr, error) {
	...
	case *parser.IntervalLit:
		return &IntervalLit{pos: x.Pos(), Value: x.Value, Unit: x.Unit, Qualified: x.Qualified, PreComputed: x.PreComputed, PreMonths: x.PreMonths, PreDays: x.PreDays, PreMicros: x.PreMicros}, nil
	case *parser.SubqueryExpr:
