...
func TestCopyTextRowEmitsArrayColumns(t *testing.T) {
	got, err := EncodeCopyTextRow(nil, arrayCopyRow(), arrayCopyCols(), "ISO", "MDY", "", "hex", nil, false)
	if err != nil {
...
func TestCopyCsvRowQuotesArrayColumns(t *testing.T) {
	...
	got, err := EncodeCopyCsvRow(nil, arrayCopyRow(), arrayCopyCols(), f, "ISO", "MDY", "", "hex", nil, false)
	if err != nil {
...
func TestCopyTextArrayRoundTripsThroughItsOwnOutput(t *testing.T) {
	...
	line, err := EncodeCopyTextRow(nil, row, cols, "ISO", "MDY", "", "hex", nil, false)
	if err != nil {
		t.Fatalf("EncodeCopyTextRow: %v", err)
	}
